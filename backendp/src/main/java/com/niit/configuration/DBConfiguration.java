...
//to create beans
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/practice");
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{Product.class,Category.class,Customer.class,User.class,Authorities.class,ShippingAddress.class,BillingAddress.class,CartItem.class,CustomerOrder.class}; //If product class is not yet created, remove this and add it later
